...
/** @internal */
export const AgentsCompletionStreamRequestToolChoice$inboundSchema:
  z.ZodNativeEnum<typeof AgentsCompletionStreamRequestToolChoice> = z
    .nativeEnum(AgentsCompletionStreamRequestToolChoice);

/** @internal */
export const AgentsCompletionStreamRequestToolChoice$outboundSchema:
  z.ZodNativeEnum<typeof AgentsCompletionStreamRequestToolChoice> =
...
> = z.object({
  ...
  tool_choice: AgentsCompletionStreamRequestToolChoice$inboundSchema.default(
    "auto",
  ),
  agent_id: z.string(),
}).transform((v) => {
...
> = z.object({
  ...
  toolChoice: AgentsCompletionStreamRequestToolChoice$outboundSchema.default(
    "auto",
  ),
  agentId: z.string(),
}).transform((v) => {
