...
/** @internal */
export const ChatCompletionStreamRequestToolChoice$inboundSchema:
  z.ZodNativeEnum<typeof ChatCompletionStreamRequestToolChoice> = z.nativeEnum(
    ChatCompletionStreamRequestToolChoice,
  );

/** @internal */
export const ChatCompletionStreamRequestToolChoice$outboundSchema:
  z.ZodNativeEnum<typeof ChatCompletionStreamRequestToolChoice> =
...
> = z.object({
  ...
  tool_choice: ChatCompletionStreamRequestToolChoice$inboundSchema.default(
    "auto",
  ),
...
> = z.object({
  ...
  toolChoice: ChatCompletionStreamRequestToolChoice$outboundSchema.default(
    "auto",
  ),
